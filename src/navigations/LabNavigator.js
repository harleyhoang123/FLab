      ...
      <View style = {styles.container}>
        ...
        <View style = {styles.topNavigationContent}>
          <View style = {styles.topNavigationContentLeft}>
            ...
            <TouchableOpacity style={styles.button} onPress={() => navigation.push("Document")}>
              <Text style={styles.textLogo}>Document</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.button} onPress={() => navigation.push("DocumentDetail")}>
            ...
            <TouchableOpacity style={styles.button} onPress={() => navigation.push("Spaces")}>
