...
import {changeAvatar, getProfileDetail} from "../../networking/CustomNetworkService";
...
function Profile({route, navigation}) {
    ...
    const updateAvatar = async (accountId) => {
        ...
        if (!result.cancelled) {
            ...
            changeAvatar(accountId, imagePicked).then(v => getProfileDetail(accountId).then(r => setAvatar(r.data.avatar)))
        }
    };
        ...
        <View style={styles.container}>
            ...
            <View style={styles.containerProfile}>
                <View style={styles.containerName}>
                    ...
                    />
                    <TouchableOpacity style={{right: 30}} onPress={() => updateAvatar(accountId)}>
