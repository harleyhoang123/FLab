...
import {getAllMemberInLab, getAllMemberInProject} from "../../networking/CustomNetworkService";
                ...
                .then((response) => {
                    ...
                    getAllMemberInProject()
                        .then((response) => {
                            ...
                            setData(newArray1.filter((i) => !newArray2.find(({key}) => i.key === key)));
                            console.log("DATA3: " + JSON.stringify(newArray1.filter((i) => !newArray2.find(({key}) => i.key === key))));
                        });
                });
        },
        []
