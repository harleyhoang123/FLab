...
export const routes = {
  laboratory: {
    ...
    getListMaterialByLabId: laboratory + "/flab/lab/public/api/v1/materials",
    ...
    removeMemberFromLaboratory:
      laboratory +
      "/flab/lab/public/api/v1/laboratories/:lab-id/members/:member-id",
    deleteLaboratory:
      laboratory + "/flab/lab/public/api/v1/laboratories/:lab-id",
    updateLaboratory:
      laboratory + "/flab/lab/public/api/v1/laboratories/:lab-id",
    addMemberToLab:
      laboratory +
      "/flab/lab/public/api/v1/laboratories/:lab-id/members/member",
    applyToLab:
      laboratory + "/flab/lab/public/api/v1/laboratories/:lab-id/apply",
    updateMemberRole: laboratory + "/flab/lab/public/api/v1/members/:member-id",
    getAllRequest:
      laboratory + "/flab/lab/public/api/v1/laboratories/:lab-id/applications",
    getRequestDetail:
      laboratory +
      "/flab/lab/public/api/v1/laboratories/applications/:application-id",
    getMaterialById:
      laboratory + "/flab/lab/public/api/v1/materials/:material-id",
    getMaterialByLabId:
      laboratory +
      "/flab/lab/public/api/v1/laboratories/:laboratory-id/materials",
    updateMaterial:
      laboratory +
      "/flab/lab/public/api/v1/laboratories/:laboratory-id/materials/:material-id",
    addMaterial:
    ...
    removeMemberInProject:
      laboratory +
      "/flab/lab/public/api/v1/projects/:project-id/members/:member-id",
    removeProject:
    ...
    updateProject:
      laboratory +
      "/flab/lab/public/api/v1/laboratories/:laboratory-id/projects/:project-id",
    addMemberToProject:
      laboratory +
      "/flab/lab/public/api/v1/projects/:project-id/members/member",
    getAllMemberInLab:
      laboratory + "/flab/lab/public/api/v1/laboratories/:lab-id/members",
    deleteMaterial:
      laboratory +
    ...
    responseOrder: laboratory + "/flab/lab/public/api/v1/materials/:order-id",
    reviewRequest:
      laboratory +
      "/flab/lab/public/api/v1/laboratories/:lab-id/:application-id",
    getListOrderByAccountId:
      laboratory +
      "/flab/lab/public/api/v1/laboratories/:laboratory-id/:account-id/materials",
    returnOrder:
  ...
  forum: {
    ...
    addCommentToQuestion:
      forum + "/flab/forum/public/api/v1/questions/:question-id/comment",
    addCommentToAnswer: forum + "/flab/forum/public/api/v1/answers/:answer-id",
    deleteAnswerCustom:
    ...
    editComment: forum + "/flab/forum/public/api/v1/comments/:comment-id",
    editAnswer: forum + "/flab/forum/public/api/v1/answers/:answer-id",
    voteQuestion:
      forum + "/flab/forum/public/api/v1/questions/:question-id/vote",
    getAllTag: forum + "/flab/forum/public/api/v1/tags",
  ...
  repository: {
    ...
    getFolderByRepositoryId:
      repository +
      "/flab/repository/public/api/v1/repositories/:repository-id/folders",
    createFolderInRepository:
      repository +
      "/flab/repository/public/api/v1/repositories/:repository-id/folder",
    createSubFolder:
      repository + "/flab/repository/public/api/v1/folders/:folder-id",
    ...
    deleteFolderInRepository:
      repository +
      "/flab/repository/public/api/v1/repositories/:repository-id/:folder-id",
    getListFolder:
      repository +
      "/flab/repository/public/api/v1/repositories/:repository-id/folders",
    deleteFolder:
      repository +
      "/flab/repository/public/api/v1/folders/:folder-id/folders/:sub-folder-id",
    deleteFile:
      repository +
      "/flab/repository/public/api/v1/folders/:folder-id/files/:file-id",
    getListFolderDetail:
      repository + "/flab/repository/public/api/v1/folders/:folder-id",
  },
  account: {
    ...
    updateAccountInfo:
      account + "/flab/account/public/api/v1/profiles/:profile-id",
    login: account + "/flab/account/public/api/v1/accounts/account/login",
    register: account + "/flab/account/public/api/v1/accounts/account",
    forgot: account + "/flab/account/public/api/v1/accounts/password/reset",
    changePassword:
      account + "/flab/account/public/api/v1/accounts/:account-id/password",
    getMemberDetail:
      account + "/flab/account/public/api/v1/profiles/:profile-id",
    getAllMember: account + "/flab/account/public/api/v1/accounts",
    getAllCVOfAccount:
      account + "/flab/account/public/api/v1/profiles/:account-id/cv",
    uploadProfileCv: account + "/flab/account/public/api/v1/cv/:profile-id",
    getCVbyAccountId:
      account + "/flab/account/public/api/v1/profiles/:account-id/cv",
    deleteCVbyAccountId:
      account + "/flab/account/public/api/v1/cv/:profile-id/:cv-id",
    updateProfileCv: account + "/flab/account/public/api/v1/cv/:cv-id",
    changeAvatar:
  ...
  notification: {
    ...
    updateNews: notification + "/flab/notification/public/api/v1/news/:news-id",
    getNewsDetail:
      notification + "/flab/notification/public/api/v1/news/:news-id",
    deleteNews: notification + "/flab/notification/public/api/v1/news/:news-id",
    commentToNews:
      notification + "/flab/notification/public/api/v1/news/:news-id/comment",
    commentToComment:
      notification +
      "/flab/notification/public/api/v1/comments/:comment-id/comment",
    editCommentNews:
      notification + "/flab/notification/public/api/v1/comments/:comment-id",
    deleteCommentInNews:
      notification +
      "/flab/notification/public/api/v1/news/:new-id/:comment-id",
  ...
  workSpace: {
    ...
    getListSprint:
      workspace + "/flab/workspace/public/api/v1/sprints/:workspace-id/sprints",
    getTaskDetail: workspace + "/flab/workspace/public/api/v1/tasks/:task-id",
    getSubTaskDetail:
      workspace + "/flab/workspace/public/api/v1/subtasks/:subtask-id",
    deleteSprint:
      workspace +
      "/flab/workspace/public/api/v1/sprints/:workspace-id/sprints/:sprint-id",
    createTask:
      workspace +
      "/flab/workspace/public/api/v1/tasks/:workspace-id/:sprint-id/task",
    getListTask: workspace + "/flab/workspace/public/api/v1/sprints/:sprint-id",
    updateSprint:
      workspace +
      "/flab/workspace/public/api/v1/sprints/:workspace-id/:sprint-id",
    updateStatusSprint:
      workspace +
      "/flab/workspace/public/api/v1/sprints/:workspace-id/:sprint-id",
    getSprintDetail:
    ...
    deleteSubTask:
      workspace +
      "/flab/workspace/public/api/v1/subtasks/:task-id/subtasks/:subtask-id",
    updateSubTask:
      workspace +
      "/flab/workspace/public/api/v1/subtasks/:workspace-id/:subtask-id",
    assignSubTask:
      workspace +
      "/flab/workspace/public/api/v1/subtasks/:workspace-id/:subtask-id",
    createSubTask:
      workspace +
      "/flab/workspace/public/api/v1/subtasks/:workspace-id/:task-id/subtask",
    getListSubTask: workspace + "/flab/workspace/public/api/v1/tasks/:task-id",
    updateTask:
